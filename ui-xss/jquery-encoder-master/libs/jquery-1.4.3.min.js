...
(function (E, A) {
    ...
    c._ = {"for": "htmlFor", "class": "className", readonly: "readOnly", maxlength: "maxLength",
    ...
    c.event = {add: function (a, b, d, e) {
        ...
        return a.result
    }, _: "altKey attrChange attrName bubbles button cancelable charCode clientX clientY ctrlKey currentTarget data detail eventPhase fromElement handler keyCode layerX layerY metaKey newValue offsetX offsetY pageX pageY prevValue relatedNode relatedTarget screenX screenY shiftKey srcElement target toElement view wheelDelta which".split(" "),
        fix: function (a) {
            if (a[c.expando])return a;
            var b = a;
            a = c.Event(b);
            for (var d = this._.length, e; d;) {
                e = this._[--d];
                a[e] = b[e]
            }
